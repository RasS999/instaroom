...
if (isset($_GET['uid']) && isset($_GET['newEmail'])) {
    ...
    $serverIP = "192.168.208.80"; // Replace localhost with your actual IP
    $verificationUrl = "http://{$serverIP}:8000/app_verify_new_email.php?uid={$uid}&newEmail=" . urlencode($newEmail);
